import{d as t,m as o,c as s,a as e,n as r,u as n,F as i,o as l,e as c}from"./index-CNoZ-Cqy.js";const d=`### Scanning through user presentable data
...
and not the keyword, I used the regular expression \`\`\`[",]EQ[",]\`\`\` as EQ can appear in a comma seperated string "EQ,AR"
...
`,g=["innerHTML"],f=t({__name:"RegexView",setup(u){const a=o(d).mkd;return(h,m)=>(l(),s(i,null,[e("h2",{style:r(n(c)("h2"))},"Regular Expressions",4),e("article",{id:"contents",innerHTML:n(a)},null,8,g)],64))}});export{f as default};
