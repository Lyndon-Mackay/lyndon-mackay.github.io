import{d as o,m as a,c as s,a as e,n as i,u as n,F as r,o as c,e as d}from"./index-DdRBqozk.js";const h=`### Linking Vendor data with ERP data
...
`,m=["innerHTML"],f=o({__name:"ExcelView",setup(l){const t=a(h).mkd;return(u,p)=>(c(),s(r,null,[e("h2",{style:i(n(d)("h2"))},"My Excel experience",4),e("article",{id:"contents",innerHTML:n(t)},null,8,m)],64))}});export{f as default};
